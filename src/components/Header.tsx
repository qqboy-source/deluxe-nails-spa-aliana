                ...
                <div className="flex items-center justify-between h-20">
                    ...
                    <nav className="hidden md:flex items-center">
                        <div className="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="tel:2817620878" className="ml-4 text-gray-900 font-semibold px-4 py-2 rounded-md text-sm btn-golden-glow">
                                Book Your Escape
                            </a>
                        </div>
                    </nav>
                ...
                <div className="md:hidden bg-white/80 backdrop-blur-sm pb-4">
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        {navLinks.map(link => (
                         ...
                         <a href="tel:2817620878" className="block w-full text-center text-gray-900 font-semibold mt-2 px-3 py-2 rounded-md text-base btn-golden-glow">
                            Book Your Escape
                        </a>
                    </div>
                </div>
